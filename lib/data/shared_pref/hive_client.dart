...
class HiveClient {
  ...
  /// --------------------------------------------------------------------------/ Language
  //Source
  void updateLanguageSource(String newValue) {
    globalBox.put(LANGUAGE_SOURCE, newValue);
  }
  ...
  //To
  void updateLanguageTo(String newValue) {
    globalBox.put(LANGUAGE_TO, newValue);
  }
